---
name: gps-method
description: This skill should be used when the user asks to "set a goal", "achieve a goal", "create a plan", "why am I not making progress", "diagnose my goal", "GPS method", "goal setting framework", or needs guidance on systematic goal achievement, breaking down objectives, or troubleshooting why they're stuck on a goal.
---
